...
/**
 * Created by Abdel on 02/06/2015.
 */
public class FeedsViewPagerTransformer implements ViewPager.PageTransformer {
    ...
    FeedsViewPagerTransformer(TransformType transformType) {
